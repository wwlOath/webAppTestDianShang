		...
		methods: {
			async loadData(e){
				...
				const curList = [{
					...
					"products": [
						{
							"image": "https://vkceyugu.cdn.bspapp.com/VKCEYUGU-mix-mall-admin/bf376481-1835-4b5a-9538-865c5d133859.jpg",
					...
					"products": [
						{
							"image": "https://7478-tx-cloud-mix-mall-d6944c-1302673523.tcb.qcloud.la/1595600801861640520.jpg",
							"title": "阿玛尼（ARMANI）臻致丝绒哑光唇釉405 6.5ml",
							"sku": {
								"name": "个护彩妆"
							},
							"price": 260,
